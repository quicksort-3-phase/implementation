...
#ifndef CDP_QUICKSORT_H
#define CDP_QUICKSORT_H
...
template <typename T>
__global__ void qsort_warp(T *indata, T *outdata, unsigned int len, qsortAtomicData *atomicData, qsortRingbuf *ringbuf, unsigned int source_is_indata,
                           unsigned int depth);
template <typename T>
__global__ void bitonicsort(T *indata, T *outdata, unsigned int offset, unsigned int len);
template <typename T>
__global__ void big_bitonicsort(T *indata, T *outdata, unsigned *backbuf, unsigned int offset, unsigned int len);
